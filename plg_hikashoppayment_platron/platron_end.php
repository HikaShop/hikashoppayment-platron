<?php
/**
 * @package	Platron payment plugin for HikaShop - Joomla!
 * @version	2.6.1
 * @author	hikashop.com
...
<div class="hikashop_platron_end" id="hikashop_platron_end">
	...
	<form id="hikashop_platron_form" name="hikashop_platron_form" action="<?php echo $this->url; ?>" method="post">
		...
		<?php
			...
			$doc->addScriptDeclaration("window.hikashop.ready( function() {document.getElementById('hikashop_platron_form').submit();});");
